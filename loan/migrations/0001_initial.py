# Generated by Django 4.1.2 on 2023-07-09 16:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract', models.UUIDField(default=None, null=True, verbose_name='contract number')),
                ('loan_amount', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='loan loan_amount')),
                ('loan_start_date', models.DateField(verbose_name='start loan')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('principal_payment', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='principal payment')),
                ('interest_payment', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='interest payment')),
                ('is_active', models.BooleanField(default=True)),
